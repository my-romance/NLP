...
많은 문장들을 수집하여 단어와 단어 사이의 출현 빈도를 세어, 언어의 문장 분포를 모델링하는 것이 궁극적인 목표.
...
4. OCR
   ...
   : 언어 모델은 두 문장을 비교하여, 더 적절한 문장의 character sequence를 OCR결과로 나올 수 있게 이용된다.

5. other NLG tasks

   : 뉴스 기사 생성, chat-bot, 검색어 자동 완성 등
